...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarTablaDeContenido(Container container) {
        ...
        botonReporte.setBounds(190, 500, 150, 20);
    ...
    private void configurarCamposDelFormulario(Container container) {
        ...
        botonLimpiar.setBounds(100, 175, 100, 20);
    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    cantidadEliminada = this.productoController.modificar(nombre, descripcion, cantidad, id);

                    JOptionPane.showMessageDialog(this, cantidadEliminada + " items fueron editados!");
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    JOptionPane.showMessageDialog(this, cantidadEliminada + " items fueron eliminados!");
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
